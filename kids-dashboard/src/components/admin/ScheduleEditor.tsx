        ...
        return (
          ...
          >
            ...
            <input
              ...
              className="w-full mt-3 rounded-xl border border-slate-300 px-3 py-2 text-lg outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100"
            />
